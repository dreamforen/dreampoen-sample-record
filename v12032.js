...
(function(){
  ...
  function prepareStickyActions(){const row=document.querySelector('#dfViewSample .v85-action-row'),toolbar=document.querySelector('#dfViewSample .v85-sheet-toolbar');if(!row||!toolbar||row.dataset.v12032)return;row.dataset.v12032='1';row.classList.add('df-sample-sticky-actions');toolbar.parentNode.insertBefore(row,toolbar)}
